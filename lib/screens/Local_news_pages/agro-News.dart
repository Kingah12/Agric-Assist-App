...
import '../../model/News_datas/agronews_datas.dart';
import '../../model/article_view.dart';
import '../../model/category_article.dart';
import '../../model/news_model.dart';

class AgroNewsNg extends StatefulWidget {
  const AgroNewsNg({Key? key}) : super(key: key);

  @override
  _AgroNewsNgState createState() => _AgroNewsNgState();
}

class _AgroNewsNgState extends State<AgroNewsNg> {
  // List<CategoryModel> categoryModel = getCategoryNews();

  List<AgroNewsArticle> newsArticle = <AgroNewsArticle>[];
  ...
  ///get news function
  getNews() async {
    AgroNewsData newsClass = AgroNewsData();
    await newsClass.getAgricNewsArticle();
    newsArticle = newsClass.agricNews;
    setState(() {
      _loadng = false;
    });
    print(newsArticle.length);
    textsa = newsArticle.length;
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemBuilder: (context, index) => blogTile(
                                imageUrl: newsArticle[index].thumbnail,
                                title: newsArticle[index].title,
                                descr: newsArticle[index].snippet,
                                url: newsArticle[index].link,
                              )),
                    ),
                  ],
                )),
