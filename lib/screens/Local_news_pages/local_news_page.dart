import 'package:agro_assist/screens/custom_widgets/email_us.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => EmailUs_Page()));
        },
      ),
      body: SafeArea(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          const EdgeInsets.only(left: 8.0, top: 5, right: 5),
                      child: Text(
                        widget.subtitle,
