class AgronomicsPractices {
  ...
  AgronomicsPractices({
    ...
    required this.diseaseAndSymptoms,
    required this.pestInclude,
...
List<AgronomicsPractices> agroPractices = <AgronomicsPractices>[
  AgronomicsPractices(
      ...
      requiredTemperature: "An average of 25 – 30C",
      ...
      landPreparation: "Land clearing can be done manually or mechanically.",
      tillageOperation:
      ...
      harvest:
          "seed yams mature 6 – 7 months after planting or transplanting. Leaves turn yellow and die 5 – 6 months after planting followed by the drying up and death of vines. Harvest using hoe, digger, cutlass, spears etc.",
  ...
  AgronomicsPractices(
      ...
      requiredTemperature:
          "Xanthosoma specie require 21 to 250C Colocasia specie requires lower temperature of below 210C but will damage at temperature below 100C",
      soilRequirement: "Xanthosoma require fertile, well-drained sandy soil.",
      ...
      landPreparation: "Land clearing can be done manually or mechanically.",
      tillageOperation:
          "mounds or ridges can be made 1m X 1m apart Manually by use of hoe or mechanically by a tractor coupled ridger.",
      ...
      diseaseAndSymptoms:
          'Fungus attack cocoyam plant, leaves turn yellow prematurely as the entire plant wilts and damping off of the seedlings may also occur.',
      pestInclude:
      ...
      packaging: "psacks, polythene/nylon",
      symptoms: '',
      processingTools: '',
      economicImportance: '',
      uses: ''),
  AgronomicsPractices(
    ...
    landPreparation: "can be done manually, mechanically or chemically",
    tillageOperation:
  ...
  AgronomicsPractices(
      ...
      landPreparation:
          "can be done manually or mechanically by use of hoe or tractor respectively.",
      tillageOperation:
          "mounds or ridges can be made manually by use of hoe or mechanically by use of tractor.",
      ...
      diseaseAndSymptoms: "null",
      pestInclude: "Leaf miner fly, Colorado potato beetle, Potato tuber moth.",
      disease:
          "Late blight, Wart disease, Dry rot, Mosaic disease, Leaf roll, Potato black leg, Virus.",
      symptoms: "null",
  ...
  AgronomicsPractices(
      ...
      landPreparation:
          "The plantation soil should be fertilized with well decomposed organic matter and cleaned from weed.",
      tillageOperation:
          "Plantation tilling improves the soil structure this could be done manually by use of hoes or mechanically by use of tractors.",
      ...
      diseaseAndSymptoms: "",
      pestInclude:
          "Rhinoceros beetle, bag worms, red palm weevils and mealy bug.",
      disease:
          "stem wet rots, basal stem rot, bud rot, pestalotiopsis leaf spots and oil palm wilt etc.",
      symptoms: "",
      pestDiseaseControl:
  ...
  AgronomicsPractices(
      ...
      tillageOperation: "Dry seeds from matured pods ",
      plantingMaterials:
      ...
      diseaseAndSymptoms: "",
      pestInclude: "Grasshopper, leaf beetle, sucking bugs.",
  ...
  AgronomicsPractices(
      ...
      landPreparation: "Land is cleared manually or mechanically.",
      tillageOperation:
      ...
      diseaseAndSymptoms: "",
      pestInclude: "Butterflies, Moths, Beetles, Weevil, Termites etc.",
      disease:
  ...
  AgronomicsPractices(
      ...
      landPreparation:
          "land is cleared manually by the use of local tools or mechanically with tractor implement.",
      tillageOperation:
  ...
  AgronomicsPractices(
      ...
      requiredTemperature: "Accommodate a wide range of 23.8 - 350C",
      soilRequirement:
      ...
      landPreparation:
          "Early land preparation is an important step in okra production. Clear debris with cutlass, add compost o field in advance and turn in the composition into the soil. Give them time to decompose before okra is planted. Conduct soil test to check for nematode if there is any trace it is important to fumigate the soil because okra is very susceptible to damage from nematode",
      tillageOperation:
      ...
      diseaseAndSymptoms: "",
      pestInclude: "Aphids and sting buds",
      disease:
  ...
  AgronomicsPractices(
      ...
      tillageOperation:
          "Little mounds or ridges should be made manually or mechanically.",
  ...
  AgronomicsPractices(
      ...
      diseaseAndSymptoms: "",
      pestInclude: "Bean leaf beetles, cut worms, and slugs.",
  ...
  AgronomicsPractices(
      ...
      landPreparation:
          "Land can be prepared through mechanical or manual means. Debris should be cleared and tillage should be done afterwards.",
      tillageOperation:
  ...
  AgronomicsPractices(
      ...
      requiredTemperature: "mean annual temperature of 27 – 30C",
      ...
      landPreparation:
          "Clear debris and till the soil in other to loosen them for water and nutrient penetration.",
      ...
      diseaseAndSymptoms: "",
      pestInclude: "Flies, scale insects (coccus hesparidum).",
      disease:
  ...
  AgronomicsPractices(
      ...
      requiredTemperature: "Mean temperature of 260 - 30C",
      soilRequirement: "Well-drained sandy loam soil",
